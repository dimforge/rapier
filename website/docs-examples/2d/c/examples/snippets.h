...
static void RAPIER_CALL snippets_abort_on_error(R2Status status, const char *message, void *user_data) {
    (void)user_data;
...
static inline void snippets_init(void) {
    R2ErrorHandler handler = {snippets_abort_on_error, NULL};
    r2SetErrorHandler(handler);
}
#endif
