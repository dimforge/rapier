...
```c
<load path='/2d/c/examples/rigid_bodies2.c' marker='Velocity1' />
```
```c
<load path='/2d/c/examples/rigid_bodies2.c' marker='Velocity2' />
```
...
```c
<load path='/3d/c/examples/rigid_bodies3.c' marker='Velocity1' />
```
```c
<load path='/3d/c/examples/rigid_bodies3.c' marker='Velocity2' />
```
...
```python
<load path='/3d/python/rigid_bodies.py' marker='Velocity1' />
```
```python
<load path='/3d/python/rigid_bodies.py' marker='Velocity2' />
```

</py>

Alternatively, the velocity of a dynamic rigid-body can be altered indirectly by
[applying a force or an impulse](./rigid_bodies.mdx#forces-and-impulses).
