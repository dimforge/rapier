...
```c
<load path='/2d/c/examples/rigid_bodies2.c' marker='Dominance1' />
```
```c
<load path='/2d/c/examples/rigid_bodies2.c' marker='Dominance2' />
```
...
```python
<load path='/3d/python/rigid_bodies.py' marker='Dominance1' />
```
```python
<load path='/3d/python/rigid_bodies.py' marker='Dominance2' />
```
