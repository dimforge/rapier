...
or with [contact modification](./advanced_collision_detection.mdx#contact-modification). The paragraph bellow is almost identical to the paragraph about [friction](./colliders.mdx#friction).
:::
