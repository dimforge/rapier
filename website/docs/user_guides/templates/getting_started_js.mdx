...
An example of this in action can be see in the [Rapier.js testbed code](https://github.com/dimforge/rapier/blob/master/bindings/typescript/testbed2d/src/Graphics.ts).
