...
```c
<load path='/2d/c/examples/rigid_bodies2.c' marker='Damping1' />
```
```c
<load path='/2d/c/examples/rigid_bodies2.c' marker='Damping2' />
```
...
```python
<load path='/3d/python/rigid_bodies.py' marker='Damping1' />
```
```python
<load path='/3d/python/rigid_bodies.py' marker='Damping2' />
```
