...
pub async fn main() {
    ...
    let mut builders: Vec<Example> = vec![
        ...
        Example::new(COLLISIONS, "Convex decomposition", convex_decomposition3::init_world),
        Example::new(COLLISIONS, "Convex polyhedron", convex_polyhedron3::init_world),
        Example::new(COLLISIONS, "TriMesh", trimesh3::init_world),
        #[cfg(not(target_arch = "wasm32"))]
        Example::new(COLLISIONS, "Dynamic trimeshes", dynamic_trimesh3::init_world),
        Example::new(COLLISIONS, "Heightfield", heightfield3::init_world),
        Example::new(COLLISIONS, "Voxels", voxels3::init_world),
        Example::new(COLLISIONS, "Collision groups", collision_groups3::init_world),
        Example::new(COLLISIONS, "One-way platforms", one_way_platforms3::init_world),
        // ── Dynamics ─────────────────────────────────────────────────────────
        ...
        Example::new(JOINTS, "Multibody Joints", joints3::init_world_with_articulations),
        Example::new(JOINTS, "Rope Joints", rope_joints3::init_world),
        Example::new(JOINTS, "Spring Joints", spring_joints3::init_world),
        Example::new(JOINTS, "Joint Motor Position", joint_motor_position3::init_world),
        Example::new(JOINTS, "Inverse kinematics", inverse_kinematics3::init_world),
        // ── Controls ─────────────────────────────────────────────────────
        Example::new(CONTROLS, "Character controller", character_controller3::init_world),
        Example::new(CONTROLS, "Vehicle controller", vehicle_controller3::init_world),
        ...
        Example::new(DEBUG, "Add/rm collider", debug_add_remove_collider3::init_world),
        ...
        Example::new(DEBUG, "Dyn. collider add", debug_dynamic_collider_add3::init_world),
        ...
        Example::new(DEBUG, "High mass ratio: chain", debug_chain_high_mass_ratio3::init_world),
        Example::new(DEBUG, "High mass ratio: cube", debug_cube_high_mass_ratio3::init_world),
        ...
        Example::new(DEBUG, "Shape modification", debug_shape_modification3::init_world),
        Example::new(DEBUG, "Sleeping kinematics", debug_sleeping_kinematic3::init_world),
        #[cfg(not(target_arch = "wasm32"))]
        Example::new(DEBUG, "Deserialize", debug_deserialize3::init_world),
        Example::new(DEBUG, "Multibody ang. motor pos.", debug_multibody_ang_motor_pos3::init_world),
    ];
