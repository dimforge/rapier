...
Six overlapping fixed grounds and two dynamic flat cuboids stacked on
top — exercises overlap handling and contact manifold accumulation.
"""
...
def init_world(testbed) -> None:
    ...
    for _ in range(2):
        ...
        handle = bodies.insert(body)
        colliders.insert_with_parent(rp.Collider.cuboid(2.0, 0.1, 1.0), handle, bodies)
