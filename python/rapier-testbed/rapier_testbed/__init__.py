...
def _autoload_bundled_examples() -> None:
    ...
    _bundled = (
        ...
        "rapier_testbed.examples3.debug_add_remove_collider3",
        "rapier_testbed.examples3.debug_articulations3",
        "rapier_testbed.examples3.debug_balls3",
        "rapier_testbed.examples3.debug_big_colliders3",
        "rapier_testbed.examples3.debug_boxes3",
        "rapier_testbed.examples3.debug_chain_high_mass_ratio3",
        "rapier_testbed.examples3.debug_cube_high_mass_ratio3",
        "rapier_testbed.examples3.debug_cylinder3",
        "rapier_testbed.examples3.debug_deserialize3",
        "rapier_testbed.examples3.debug_disabled3",
        "rapier_testbed.examples3.debug_dynamic_collider_add3",
        "rapier_testbed.examples3.debug_eccentric_boxes3",
        "rapier_testbed.examples3.debug_friction3",
        "rapier_testbed.examples3.debug_infinite_fall3",
        "rapier_testbed.examples3.debug_internal_edges3",
        "rapier_testbed.examples3.debug_long_chain3",
        "rapier_testbed.examples3.debug_multibody_ang_motor_pos3",
        "rapier_testbed.examples3.debug_pop3",
        "rapier_testbed.examples3.debug_prismatic3",
        "rapier_testbed.examples3.debug_rollback3",
        "rapier_testbed.examples3.debug_shape_modification3",
        "rapier_testbed.examples3.debug_sleeping_kinematic3",
        # ── 3D examples (second half) ───────────────────────────────
        "rapier_testbed.examples3.debug_thin_cube_on_mesh3",
        "rapier_testbed.examples3.debug_triangle3",
        "rapier_testbed.examples3.debug_trimesh3",
        "rapier_testbed.examples3.debug_two_cubes3",
        ...
        "rapier_testbed.examples2.debug_box_ball2",
        "rapier_testbed.examples2.debug_compression2",
        "rapier_testbed.examples2.debug_intersection2",
        "rapier_testbed.examples2.debug_total_overlap2",
        "rapier_testbed.examples2.debug_vertical_column2",
