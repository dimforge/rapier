...
impl<N: SimdRealCopy> TwoBodyConstraintTangentPart<N> {
        ...
        N::AngVector: SimdDot<N::AngVector, Result = N>,
    {
        #[cfg(feature = "dim2")]
        {
            ...
            solver_vel1.linear += tangents1[0].component_mul_simd(im1) * dlambda;
        ...
        #[cfg(feature = "dim3")]
        {
            ...
            solver_vel1.linear += tangents1[0].component_mul_simd(im1) * dlambda[0]
                + tangents1[1].component_mul_simd(im1) * dlambda[1];
...
impl<N: SimdRealCopy> TwoBodyConstraintNormalPart<N> {
    ...
    pub fn solve(
        ...
        N::AngVector: SimdDot<N::AngVector, Result = N>,
    {
        let dvel = dir1.gdot(solver_vel1.linear) + self.gcross1.gdot(solver_vel1.angular)
        ...
        solver_vel1.linear += dir1.component_mul_simd(im1) * dlambda;
